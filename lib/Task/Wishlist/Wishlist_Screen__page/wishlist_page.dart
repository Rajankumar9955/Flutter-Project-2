...
// All produts
           ...
           BlocBuilder<WishProductBloc, WishProductState>(
            bloc:_wishProductBloc,
            builder: (context, state){
            if(state is WishProductInitial || state is WishProductLoading){
              return Center(child: CircularProgressIndicator(),);
            }else if(state is WishProductLoaded){
              final wishlislength=state.wishlistProducts.length;
            ...
            }else if(state is WishProductError){
